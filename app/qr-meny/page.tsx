...
const HUB_FAQ = [
  {
    ...
    answer:
      "En QR-meny är en restaurangmeny som visas i gästens egen mobil när hen skannar en QR-kod på bordet. Inga appar, inga inloggningar — menyn öppnas direkt i webbläsaren. Servera är en sådan plattform, byggd för svenska restauranger med fast månadskostnad i SEK utan provisioner per order.",
  },
  {
